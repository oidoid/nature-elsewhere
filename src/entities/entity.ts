...
import {ImageStateMap} from '../images/image-state-map'
import {RectArray} from '../math/rect-array'
import {Rect} from '../math/rect'
import {UpdatePredicate} from './updaters/update-predicate'
...
export namespace Entity {
  ...
  export function moveBy(entity: Entity, by: XY): UpdateStatus {
    ...
    // entity.bounds.x = imageState(entity).bounds.x
    // entity.bounds.y = imageState(entity).bounds.y
