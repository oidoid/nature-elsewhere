...
fn layout_word(
  ...
  for index in index..chars.len() {
    ...
    letters.push(Some(R16::new_size(x, y, w, h)));
    x += span;
  }
  ...
  fn layout() {
    ...
    [
      ...
      (
        ...
        TextLayout {
          letters: vec![
            Some(R16::new_size(0, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 0 * font.line_height, 3, font.letter_height)),
            None,
            Some(R16::new_size(
              14,
              0 * font.line_height,
      ...
      (
        ...
        TextLayout {
          letters: vec![
            Some(R16::new_size(0, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 1 * font.line_height, 3, font.letter_height)),
            None,
            Some(R16::new_size(6, 1 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 2 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 2 * font.line_height, 3, font.letter_height)),
            None,
            Some(R16::new_size(0, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 3 * font.line_height, 1, font.letter_height)),
            None,
            Some(R16::new_size(0, 4 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 4 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 4 * font.line_height, 1, font.letter_height)),
            None,
            Some(R16::new_size(0, 5 * font.line_height, 5, font.letter_height)),
            Some(R16::new_size(6, 5 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 6 * font.line_height, 3, font.letter_height)),
          ],
      ...
      (
        ...
        TextLayout {
          letters: vec![
            ...
            None,
            Some(R16::new_size(0, 1 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 1 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 1 * font.line_height, 3, font.letter_height)),
            None,
            Some(R16::new_size(0, 2 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 2 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 2 * font.line_height, 1, font.letter_height)),
            None,
            Some(R16::new_size(0, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(8, 3 * font.line_height, 1, font.letter_height)),
            None,
            Some(R16::new_size(0, 4 * font.line_height, 5, font.letter_height)),
            Some(R16::new_size(6, 4 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(
              10,
              4 * font.line_height,
              3,
      ...
      (
        ...
        TextLayout {
          letters: vec![
            ...
            None,
            Some(R16::new_size(0, 3 * font.line_height, 5, font.letter_height)),
            Some(R16::new_size(6, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(
              10,
              3 * font.line_height,
              3,
    ...
    [
      ...
      (
        ...
        TextLayout {
          letters: vec![
            Some(R16::new_size(0, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 0 * font.line_height, 1, font.letter_height)),
          ],
      ...
      (
        ...
        TextLayout {
          letters: vec![
            ...
            Some(R16::new_size(0, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 4 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 5 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 6 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 7 * font.line_height, 3, font.letter_height)),
          ],
      ...
      (
        ...
        TextLayout {
          letters: vec![
            ...
            Some(R16::new_size(0, 5 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 6 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(4, 6 * font.line_height, 3, font.letter_height)),
          ],
      ...
      (
        ...
        TextLayout {
          letters: vec![
            Some(R16::new_size(1, 0 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 1 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 2 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 3 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 4 * font.line_height, 3, font.letter_height)),
      ...
      (
        ...
        TextLayout {
          letters: vec![
            ...
            Some(R16::new_size(0, 6 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 7 * font.line_height, 3, font.letter_height)),
            Some(R16::new_size(0, 8 * font.line_height, 3, font.letter_height)),
          ],
