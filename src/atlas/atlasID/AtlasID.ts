...
export enum AtlasID {
  ...
  UI_LEVEL_EDITOR_BUTTON_CREATE = 'uiLevelEditorButton-create',
  UI_LEVEL_EDITOR_BUTTON_BASE = 'uiLevelEditorButton-base',
  UI_LEVEL_EDITOR_BUTTON_DECREMENT = 'uiLevelEditorButton-decrement',
  UI_LEVEL_EDITOR_BUTTON_TOGGLE_GRID = 'uiLevelEditorButton-toggleGrid',
  UI_LEVEL_EDITOR_BUTTON_INCREMENT = 'uiLevelEditorButton-increment',
  UI_LEVEL_EDITOR_BUTTON_PRESSED = 'uiLevelEditorButton-pressed',
  UI_LEVEL_EDITOR_BUTTON_DESTROY = 'uiLevelEditorButton-destroy',
  UI_GRID = 'uiGrid',
