...
export enum AtlasID {
  ...
  BAKPACKER_ICON_IDLE = 'backpackerIcon-idle',
  BAKPACKER_ICON_WALK = 'backpackerIcon-walk',
  SUBSHRUB = 'subshrub',
  SUBSHRUB_SHADOW = 'subshrub-shadow',
  TREE_SMALL = 'tree-small',
  TREE_SMALL_SHADOW = 'tree-smallShadow',
  TREE_LARGE = 'tree-large',
  TREE_LARGE_BARE = 'tree-largeBare',
  TREE_LARGE_SHADOW = 'tree-largeShadow',
  LATTICE = 'lattice',
  MOON = 'moon',
  ...
  MONUMENT_SMALL = 'monument-small',
  MONUMENT_SMALL_SHADOW = 'monument-smallShadow',
  MONUMENT_MEDIUM = 'monument-medium',
  MONUMENT_MEDIUM_SHADOW = 'monument-mediumShadow',
  ODDOID = 'oddoid',
  ...
  UI_CURSOR_HAND_POINT = 'uiCursor-hand-point',
  UI_CURSOR_HAND_PICK = 'uiCursor-hand-pick',
  UI_SWITCH = 'uiSwitch',
