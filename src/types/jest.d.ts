/* eslint-disable */
// https://github.com/DefinitelyTyped/DefinitelyTyped/pull/26236/files with case tweaks
...
declare namespace jest {
    ...
    type CaseCallback<T> = (param: T) => void;
    ...
    interface It {
        ...
        each<T>(cases: T[]): (name: string, fn: CaseCallback<T>, timeout?: number) => void;
        /**
