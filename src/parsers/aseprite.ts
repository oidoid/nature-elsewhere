export namespace Aseprite {
   ...
   * all the image, animation, and collision information for every file packed
   * in the atlas. **By convention**, every file has one or more animations.
   * Every animation has a Frame sequence, a Tag, and zero or more Slices.
   */
   ...
   * it is zero in a single frame animation. E.g., 'cloud xl 4' refers to the
   * file named "cloud.aseprite" with animation named "xs", frame index 4, and
   * 'sky  ' refers to the file named "sky.aseprite" with animation named "",
   * the first frame. See https://github.com/aseprite/aseprite/issues/1713.
   */
   ...
   * 'cactus xs' describes the file named "cactus.aseprite" with animation named
   * "xs" and 'sun ' refers to the file named "sun.aseprite" with animation
   * named "". Animation names are use to distinguish different variations like
   * size (s, m, l) or state (walk, run, fly).
   */
