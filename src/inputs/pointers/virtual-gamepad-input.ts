...
export namespace VirtualGamepadInput {
  export interface JoystickPosition extends Input {
  ...
  export interface JoystickAxes extends Input {
    ...
    /** The nonnegative fractional length from the center of the stick to the
        center of the base. This value may exceed the radius of the joystick
        base and should be capped when calculating stick render location.

        The product of each normalized component and the radius would be the
        position of the stick on the perimeter. If the lesser length of the
        radius and the magnitude is used instead, the stick may be positioned
        anywhere within the radius.
  ...
  export interface ButtonsPosition extends Input {
  ...
  export interface ButtonsPressed extends Input {
