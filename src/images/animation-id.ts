...
export enum AnimationID {
  ...
  NATURE_ELSEWHERE = 'nature-elsewhere ',
  PIXEL = 'pixel ',
  ...
  TALL_GRASS_D = 'tall-grass d',
  TALL_GRASS_E = 'tall-grass e',
  TALL_GRASS_F = 'tall-grass f',
  ...
  UI_PICK = 'ui pick',
  UI_SWITCH = 'ui-switch ',
  UI_VIRTUAL_BUTTON_ACTIVE = 'ui-virtual-button active',
  UI_VIRTUAL_BUTTON_INACTIVE = 'ui-virtual-button inactive',
  UI_VIRTUAL_JOYSTICK_BASE = 'ui-virtual-joystick base',
  UI_VIRTUAL_JOYSTICK_STICK = 'ui-virtual-joystick stick',
