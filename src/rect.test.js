...
/** [diagram, lhs, rhs, intersections, intersects, flip] */
const intersections = [
  [
    `
  ...
  (sum, val) => [...sum, [...val, false], [...val, true]],
  /** @type {(string|Rect|boolean)[][]} */ ([])
)

describe('intersection()', () => {
  test.each(intersections)('%#) %s (%p, %p) => %p %p, %p', (
    /** @type {string} */ _diagram,
    /** @type {Rect} */ lhs,
    /** @type {Rect} */ rhs,
    /** @type {Rect} */ intersection,
    /** @type {Rect} */ _intersects,
    /** @type {boolean} */ flip
  ) =>
    expect(rect.intersection(flip ? rhs : lhs, flip ? lhs : rhs)).toStrictEqual(
      intersection
    )
  )
})
...
describe('intersects()', () => {
  test.each(intersections)('%#) %s (%p, %p) => %p %p, %p', (
    ...
    /** @type {Rect} */ lhs,
    /** @type {Rect} */ rhs,
    /** @type {Rect} */ _intersection,
    /** @type {Rect} */ intersects,
    /** @type {boolean} */ flip
  ) =>
