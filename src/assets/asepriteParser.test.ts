...
import * as testExpected from './asepriteParser.expect.test'
import * as testInput from './asepriteParser.input.test.json'
...
describe('asepriteParser', () => {
  ...
  describe('#parse()', () => {
    test('Converts.', () => {
      expect(asepriteParser.parse(testInput)).toStrictEqual(
