...
export function newState(atlas, random) {
  const entities = [
    ...
    new GrassAnimation(AnimationID.GRASS_L)
      .setPosition({x: -512, y: -12})
      .setScale({x: 48, y: 1}),
    new GrassAnimation(AnimationID.GRASS_L)
      .setPosition({x: 208, y: -12})
      .setScale({x: 2, y: 1}),
    new HillAnimation().setPosition({x: 40, y: -28}),
    new GrassAnimation(AnimationID.TALL_GRASS_A).setPosition({x: 188, y: -15}),
    new GrassAnimation(AnimationID.TALL_GRASS_B).setPosition({x: 208, y: -15}),
    ...
    new GrassAnimation(AnimationID.GRASS_L)
      ...
      .setScale({x: 6, y: 1}),
    new TreeAnimation().setPosition({x: 185, y: -39}),
  ...
  const player = new PlayerAnimation().setPosition({
    x: 0,
